...
endpointClient.factory('Endpoint', function(AccessToken, $location, $translate) {
  ...
  service.redirect = function() {
    window.location.replace(service.get());
  };
...
directives.directive('oauth', function(AccessToken, Endpoint, Profile, $location, $rootScope, $compile, $http, $templateCache) {
  ...
  definition.link = function postLink(scope, element, attrs) {
    ...
    var initAttributes = function() {
      ...
      scope.template      = scope.template      || 'bower_components/oauth-ngw/dist/views/templates/default.html';
